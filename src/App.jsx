      ...
      <main className="main">
        <section className="mapContainer">
          <header className="mapHeader">
            <h2 className="secondaryHeader">Live location</h2>
        ...
        <section className="detailContainer">
          <div className="details">
            <div className="nameContainer">
              <h2 className="secondaryHeader">ISS Zarya</h2>
              <p className="id">NORAD 37820U</p>
            </div>

            <div className="advancedDetails">
              ...
              <div className="detail">
                <div className="text">
                  <p className="category">Class</p>
                  <p className="item">Communication</p>
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
              ...
              <div className="detail">
                <div className="text">
                  ...
                  <p className="item">
                    10th July 2021 at 10:24 <span className="unit">gmt</span>
                  </p>
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <aside className="statistics">
            ...
            <div className="filters">
              <header className="filtersHeader">
                ...
                <h3 className="tertiaryHeader">Filters</h3>
              </header>
              ...
              <div className="filtersWrapper">
                <div className="filter active">
                  ...
                  <p className="filterType">Communication</p>
                </div>
                ...
                <div className="filter">
                  ...
                  <p className="filterType">Navigation</p>
                </div>
                ...
                <div className="filter active">
                  ...
                  <p className="filterType">Observation</p>
                </div>
                ...
                <div className="filter">
                  ...
                  <p className="filterType">Research</p>
                </div>
              </div>
            </div>
          </aside>
